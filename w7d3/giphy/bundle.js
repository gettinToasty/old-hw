	  ...
	  _createClass(GiphysSearch, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement('input', { type: 'text', onChange: this.updateSearch }),
	        _react2.default.createElement('input', { type: 'submit', onClick: this.handleSubmit, value: 'Search' }),
